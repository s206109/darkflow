...
plt.plot(['[0-10]','[10-20]','[20-30]','[30-40]','[40 over]'],[error10, error20, error30, error40, error40over],label = 'estimation with 2.5D + orientation anchor (10)',color = 'blue')
...
plt.plot(['[0-10]','[10-20]','[20-30]','[30-40]','[40 over]'],[1.1577788484456362, 1.6437140840763669, 3.6163843362981618, 5.0210139905144189, 3.9699841791788741],label = 'estimation with 2.5D anchor (10)',color = 'red')
plt.plot(['[0-10]','[10-20]','[20-30]','[30-40]','[40 over]'],[1.2321160611658288,1.5971189845510934,2.6035604366255396, 3.4388417674045928,4.4292243364122186],label = 'estimation with 2.5D anchor (20)',color = 'orange')#20の場合
plt.plot(['[0-10]','[10-20]','[20-30]','[30-40]','[40 over]'],[1.2490914781316316,1.4512085404974877,2.6010162929318983,3.4977290793026192,3.748560212787829],label = 'estimation with 2.5D + orientation anchor (20)',color = 'green')#20の場合
...
std_error_20 = [0.095810134099037647,0.12695240038297473,0.21091872336211481,0.24269267748076877,0.31158940167142624]
std_error_20_orie = [0.095114993464107489,0.11706906856230692,0.19911843180444384,0.25516569571467587,0.42120348287731071]
...
plt.errorbar(['[0-10]','[10-20]','[20-30]','[30-40]','[40 over]'], [1.2321160611658288,1.5971189845510934,2.6035604366255396, 3.4388417674045928,4.4292243364122186], std_error_20,fmt = 'o',color = 'orange')#20の場合
plt.errorbar(['[0-10]','[10-20]','[20-30]','[30-40]','[40 over]'], [1.2490914781316316,1.4512085404974877,2.6010162929318983,3.4977290793026192,3.748560212787829], std_error2,fmt = 'o',color = 'green')#20の場合
