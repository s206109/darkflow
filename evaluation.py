...
plt.errorbar(['[0-10]','[10-20]','[20-30]','[30-40]','[40 over]'], [error10, error20, error30, error40, error40over], yerr=[std10 ,std20 ,std30, std40, std40over], xerr=None,fmt='', ecolor=None)
plt.xlabel('true distance',fontsize = 18)
