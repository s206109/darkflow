...
# jsonの読み込み
cur_dir = os.getcwd()
os.chdir('data/kitti/set1/PNGImagesTest/out_53000_orientation_50')
...
plt.plot(['[0-10]','[10-20]','[20-30]','[30-40]','[40 over]'],[1.2321160611658288,1.5971189845510934,2.6035604366255396, 3.4388417674045928,4.4292243364122186],label = 'estimation with 2.5D anchor',color = 'red')#20の場合
