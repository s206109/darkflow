...
# jsonの読み込み
cur_dir = os.getcwd()
os.chdir('data/kitti/set1/PNGImagesTest/out-50000_orientation')
...
plt.plot(['[0-10]','[10-20]','[20-30]','[30-40]','[40 over]'],[1.3100685489239987, 1.7255334254302599, 2.9142805627403616, 3.7108640245571256, 4.4222900810241699],label = 'estimation with 2.5D anchor')
