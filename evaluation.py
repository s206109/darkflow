...
plt.errorbar(['[0-10]','[10-20]','[20-30]','[30-40]','[40 over]'], [error10, error20, error30, error40, error40over], yerr=[std10/5,std20/5 ,std30/5, std40/5, std40over/5], xerr=None,fmt='ro', ecolor='')
